...
class BeerOrderControllerTest extends BaseIT {
  ...
  void createOrderNotAuth() throws Exception {
    ...
    mockMvc
        .perform(
            post(API_ROOT + stPeteCustomer.getId() + "/orders")
  ...
  void listOrdersNotAuth() throws Exception {
    mockMvc
        .perform(get(API_ROOT + stPeteCustomer.getId() + "/orders"))
        .andExpect(status().isUnauthorized());
  }
  ...
  void listOrdersAdminAuth() throws Exception {
    mockMvc.perform(get(API_ROOT + stPeteCustomer.getId() + "/orders")).andExpect(status().isOk());
  }
  ...
  void listOrdersNoAuth() throws Exception {
    mockMvc.perform(get(API_ROOT + stPeteCustomer.getId())).andExpect(status().isUnauthorized());
  }
  ...
  void getByOrderIdNotAuth() throws Exception {
    ...
    mockMvc
        .perform(get(API_ROOT + stPeteCustomer.getId() + "/orders/" + beerOrder.getId()))
        .andExpect(status().isUnauthorized());
  }
  ...
  void pickUpOrderNotAuth() throws Exception {
    ...
    mockMvc
        .perform(
            put(API_ROOT + stPeteCustomer.getId() + "/orders/" + beerOrder.getId() + "/pickup"))
        .andExpect(status().isUnauthorized());
  }
